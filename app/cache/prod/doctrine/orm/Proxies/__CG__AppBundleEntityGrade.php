 ...
 */
class Grade extends \AppBundle\Entity\Grade implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Grade' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Grade' . "\0" . 'grade', '' . "\0" . 'AppBundle\\Entity\\Grade' . "\0" . 'comment', '' . "\0" . 'AppBundle\\Entity\\Grade' . "\0" . 'lesson', '' . "\0" . 'AppBundle\\Entity\\Grade' . "\0" . 'user');
        }
    ...
    public function setLesson(\AppBundle\Entity\Lesson $lesson = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLesson', array($lesson));
    ...
    public function getLesson()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLesson', array());
